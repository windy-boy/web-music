    ...
    <div class="main-container">
      <div>
        <div class="main-hot-recommend">
          <div class="main-hot-recommend-title main-title v-hd2">
            <a href="" class="main-title-a">热门推荐</a>
            <div>
              <a href="">华语</a>
              <span>|</span>
              <a href="">流行</a>
            ...
            <ul>
              <li v-for="(item, index) in hotRecommend" :key="index">
                <div>
                  ...
                  <div class="button">
                    <a href="javascript:;" class="icon-play" @click="handleGetDetail(item.id)"></a>
        ...
        <div>
          <div class="new-disc-put">
            <div class="new-disc-upload-title main-title v-hd2">
              <a href="" class="main-title-a">榜单</a>
              <span class="main-title-span">
                <a href="">更多</a>
                <i class="s-bg"></i>
              </span>
            ...
            <div class="new-disc-put-container">
              <div>
                ...
                <div v-if="albumNewestList2.length !== 0">
                  <ul :style="'left: ' + ulLeftOfStyle[0] + 'px'" class="mk-transition-none">
                    <li v-for="(item, index) in albumNewestList1" :key="index">
                      <div>
                        <img :src="item.picUrl" alt="">
                        <a href="" :title="item.name" class="msk"></a>
                        <a href="" title="播放" class="icon-play"></a>
                      </div>
                      <p><a href="" :title="item.name">{{item.name}}</a></p>
                      <p><a href="">{{item.artist.name}}</a></p>
                    </li>
                  </ul>
                  <ul :style="'left: ' + ulLeftOfStyle[1] + 'px'" class="mk-transition-none">
                  ...
                  <ul :style="'left: ' + ulLeftOfStyle[2] + 'px'" class="mk-transition-none">
                    <li v-for="(item, index) in albumNewestList1" :key="index">
                      <div>
                        <img :src="item.picUrl" alt="">
                        <a href="" :title="item.name" class="msk"></a>
                  ...
                  <ul :style="'left: ' + ulLeftOfStyle[3] + 'px'" class="mk-transition-none">
                    <li v-for="(item, index) in albumNewestList2" :key="index">
                      <div>
                        <img :src="item.picUrl" alt="">
                        <a href="" :title="item.name" class="msk"></a>
            ...
            <div class="bill-top">
              <div v-for="(item, index) in billList" :key="index">
                ...
                <div>
                  ...
                  <div>
                    <a href="" title="播放" class="s-bg"></a>
                    <a href="" title="收藏" class="s-bg"></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div v-for="(item, index) in songList" :key="index">
                <ul>
                  <li v-for="(option, idx) in item" :key="idx">
                    <span>{{idx + 1}}</span>
                    <a href="" :title="option.name">{{option.name}}</a>
                    <div class="oper">
                      <a href="" class="s-bg" title="播放"></a>
                      <a href="" class="u-icn" title="添加到播放列表"></a>
                      <a href="" class="s-bg" title="收藏"></a>
                    </div>
                  </li>
                </ul>
                <div class="more">
      ...
      <div>
        ...
        <div>
          ...
          <ul>
            <li v-for="(item, index) in songerList" :key="index">
              <a href="">
                <img :src="item.picUrl" alt="">
                <div>
                  <h4 v-if="item.alias.length > 1">{{item.name}} {{item.alias[0]}}</h4>
          ...
          <div>
            <a href="javascript: ;" class="u-btn"><span class="u-btn">申请成为网易音乐人</span></a>
          </div>
        </div>
        <div>
          <h3>热门主播</h3>
...
export default {
  data () {
    return {
      ...
      zhuboList: [
        {
          picUrl: 'http://p2.music.126.net/H3QxWdf0eUiwmhJvA4vrMQ==/1407374893913311.jpg?param=40y40',
          name: '陈立',
          desc: '心理学家、美食家陈立教授'
        },
        {
          picUrl: 'http://p2.music.126.net/y5-sM7tjnxnu_V9LWKgZlw==/7942872001461517.jpg?param=40y40',
          name: 'DJ艳秋',
          desc: '著名音乐节目主持人'
        },
        {
          picUrl: 'http://p2.music.126.net/6cc6lgOfQTo6ovNnTHPyJg==/3427177769086282.jpg?param=40y40',
          name: '国家大剧院古典音乐频道',
          desc: '国家大剧院古典音乐官方'
        },
        {
          picUrl: 'http://p2.music.126.net/xa1Uxrrn4J0pm_PJwkGYvw==/3130309604335651.jpg?param=40y40',
          name: '谢谢收听',
          desc: '南京电台主持人王馨'
        },
        {
          picUrl: 'http://p2.music.126.net/slpd09Tf5Ju82Mv-h8MP4w==/3440371884651965.jpg?param=40y40',
          name: 'DJ晓苏',
  ...
  methods: {
    ...
    initULtransition () {
      document.querySelectorAll('.mk-transition-none')[0].style.transition = "none 1s ease 0s"
      document.querySelectorAll('.mk-transition-none')[1].style.transition = "none 1s ease 0s"
      document.querySelectorAll('.mk-transition-none')[2].style.transition = "none 1s ease 0s"
      document.querySelectorAll('.mk-transition-none')[3].style.transition = "none 1s ease 0s"
    },
    handleChangeBD (type) {
      if (type === 1 && this.antiShake) {
        ...
        if (idx > 0) {
        document.querySelectorAll('.mk-transition-none')[idx].style.transition = "left 1s ease-out 0s"
        document.querySelectorAll('.mk-transition-none')[idx - 1].style.transition = "left 1s ease-out 0s"
        ...
        setTimeout(() => {
          ...
          document.querySelectorAll('.mk-transition-none')[lastIdx].style.transition = "left 1s ease-out 0s"
          document.querySelectorAll('.mk-transition-none')[idx].style.transition = "left 1s ease-out 0s"
        ...
        if (idx < lastIdx) {
          ...
          document.querySelectorAll('.mk-transition-none')[0].style.transition = "left 1s ease-out 0s"
          document.querySelectorAll('.mk-transition-none')[idx].style.transition = "left 1s ease-out 0s"
    ...
    handleGetDJprogram () {
      getDJprogram().then(res => {
        if (res.data.code === 200) {
          ...
          console.log(this.hotRecommend, 55)
